...
namespace Zegeger.Decal.Plugins.AgentZ_II
{
    ...
    public partial class PluginCore : PluginBase
    {
        ...
        internal const string PluginName = "AgentZ II";
        internal const string PluginVersion = "0.9.0.0";
        internal const string PluginAuthor = "Zegeger of Harvestgain";
        internal const string CommandPrefix = "az";
        ...
        protected override void Startup()
        {
            try
            {
                ...
                using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Zegeger.Decal.Plugins.AgentZ_II.ViewXML.mainView.xml"))
                {
                ...
                ComponentList.Add(new ComponentExpStats(Core, View));
