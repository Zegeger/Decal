...
namespace Zegeger.Decal.Plugins.AgentC
{
    class SettingsComponent : Component
    {
        ...
        ICombo Settings_Drop;
        ITextBox Settings_Text;
        IButton Settings_Add;
        IButton Settings_Rename;
        IButton Settings_Delete;
        IStaticText Settings_Active;
        IButton Settings_Load;
        ...
        public SettingsComponent(CoreManager core, IView view) : base(core, view)
        {
